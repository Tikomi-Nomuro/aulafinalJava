...
public class HelloController {
    ...
    @FXML
    private TableColumn<Reserva, String> tbcNumSala;
    @FXML
    ...
    public void initialize() {
        ...
        tbcNumSala.setCellValueFactory(new PropertyValueFactory<>("numSala"));
    ...
    protected void onClickCadastrar() {
        if (txtNumSala.getText().trim().isEmpty()) {
            campoVazio("O campo 'Número da sala' está vazio!");
            txtNumSala.requestFocus();
            return;
        }
        ...
        reserva = new Reserva(id, txtNumSala.getText(), txtCurso.getText(), txtDisciplina.getText(),
                txtProfessor.getText(), txtData.getText(), txtHoraEntrada.getText(), txtHoraSaida.getText(),
    ...
    private void populaCampos(Reserva rsv) {
        txtNumSala.setText(rsv.getNumSala());
